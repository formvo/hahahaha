...
public class CViewpager_col extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    /**
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        {
            Intent intent = new Intent(CViewpager_col.this, CViewpager_pro.class);
            nav_char = "정보처리";
        ...
        {
            Intent intent = new Intent(CViewpager_col.this, CViewpager_sec.class);
            nav_char = "정보보안";
            intent.putExtra("name",nav_char);
            startActivity(intent);
        }
        ...
        {
            Intent intent = new Intent(CViewpager_col.this,CViewpager_cal.class);
            nav_char = "전자계산기";
            intent.putExtra("name",nav_char);
            startActivity(intent);
        }
        ...
        {
            Intent intent = new Intent(CViewpager_col.this, CViewpager_col.class);
            nav_char = "컬러리스트";
            intent.putExtra("name",nav_char);
            startActivity(intent);
        }
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            switch (getArguments().getInt(ARG_SECTION_NUMBER))
            {
                case 1:
                    // 첫 번째 아이템 추가.00
                    adapter.addItem("컬러", "설명","STL2X74DGNA") ;
